          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <div style={{ position:'relative' }}>
                <User style={{ position:'absolute', left:14, top:'50%', transform:'translateY(-50%)', width:15, height:15, color:'#71717A', pointerEvents:'none' }} />
            ...
            <div>
              ...
              <div style={{ position:'relative' }}>
                <Lock style={{ position:'absolute', left:14, top:'50%', transform:'translateY(-50%)', width:15, height:15, color:'#71717A', pointerEvents:'none' }} />
