  ...
  return (
    <div style={{ minHeight: '100vh', background:'var(--bg-page)', position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={{ position: 'relative', zIndex: 1, maxWidth: 1100, margin: '0 auto', padding: '48px 24px 80px' }}>
        ...
        {/* Back */}
        <button onClick={() => navigate('/dashboard')} style={{ display: 'flex', alignItems: 'center', gap: 6, fontSize: 13, color:'var(--text-muted)', background: 'none', border: 'none', cursor: 'pointer', marginBottom: 40 }}>
          ← Voltar ao dashboard
        </button>
        ...
        <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', gap: 12, marginBottom: 44 }}>
          <span style={{ fontSize: 14, color: !anual ? 'var(--text-primary)' : 'var(--text-muted)', fontWeight: !anual ? 600 : 400 }}>Mensal</span>
          <button
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
            <span style={{ fontSize: 14, color: anual ? 'var(--text-primary)' : 'var(--text-muted)', fontWeight: anual ? 600 : 400 }}>Anual</span>
              ...
              >
                ...
                <div style={{ padding: '28px 28px 32px' }}>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 20 }}>
                    ...
                    <div>
                      <h3 style={{ fontFamily: 'Inter, sans-serif', fontSize: 18, fontWeight: 600, color:'var(--text-primary)', lineHeight: 1 }}>{p.label}</h3>
                  ...
                  <div style={{ marginBottom: 24 }}>
                    {preco === 0 ? (
                      <div style={{ fontFamily: 'Inter, sans-serif', fontSize: 38, fontWeight: 600, color:'var(--text-primary)', letterSpacing: '-0.03em', lineHeight: 1 }}>
                        Grátis
                      </div>
                    ) : (
                      <>
                        <div style={{ display: 'flex', alignItems: 'flex-end', gap: 4 }}>
                          <span style={{ fontSize: 14, color:'var(--text-muted)', fontWeight: 600, marginBottom: 6 }}>R$</span>
                          <span style={{ fontFamily: 'Inter, sans-serif', fontSize: 42, fontWeight: 600, color: p.destaque ? p.color : 'var(--text-primary)', letterSpacing: '-0.03em', lineHeight: 1 }}>
                            {preco}
                          </span>
                          <span style={{ fontSize: 13, color:'var(--text-muted)', marginBottom: 6 }}>/mês</span>
                        </div>
                  ...
                  {ehAtual ? (
                    status?.tem_assinatura ? (
                      <button
                        ...
                        style={{ width: '100%', padding: '13px', borderRadius: 14, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6, fontSize: 14, fontWeight: 600, cursor: 'pointer', border: '1px solid rgba(255,255,255,0.1)', background: 'rgba(255,255,255,0.06)', color:'var(--text-primary)' }}
                      >
                    ...
                    <div style={{ width: '100%', padding: '13px', borderRadius: 14, textAlign: 'center', fontSize: 13, color:'var(--text-muted)', border: '1px solid rgba(255,255,255,0.07)' }}>
                    ...
                    <button
                      ...
                      style={{
                        ...
                        color: p.destaque ? 'var(--bg-card)' : p.color,
                        boxShadow: 'none',
                        transition: 'all 0.2s',
