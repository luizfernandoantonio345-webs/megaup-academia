  ...
  return (
    <div style={{ minHeight: '100vh', background: '#070B14', position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={{ position: 'relative', zIndex: 1, maxWidth: 1100, margin: '0 auto', padding: '48px 24px 80px' }}>
        ...
        {/* Back */}
        <button onClick={() => navigate('/dashboard')} style={{ display: 'flex', alignItems: 'center', gap: 6, fontSize: 13, color: '#3D4F6A', background: 'none', border: 'none', cursor: 'pointer', marginBottom: 40 }}>
          ← Voltar ao dashboard
        </button>
        ...
        <div style={{ textAlign: 'center', marginBottom: 48 }}>
          ...
          <h1 style={{ fontFamily: 'Space Grotesk, sans-serif', fontSize: 40, fontWeight: 900, color: '#EFF6FF', letterSpacing: '-0.03em', lineHeight: 1.1, marginBottom: 14 }}>
            Escolha o plano{' '}
          ...
          <p style={{ fontSize: 16, color: '#4B5768', maxWidth: 480, margin: '0 auto' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', gap: 12, marginBottom: 44 }}>
          <span style={{ fontSize: 14, color: !anual ? '#EFF6FF' : '#3D4F6A', fontWeight: !anual ? 700 : 400 }}>Mensal</span>
          <button
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
            <span style={{ fontSize: 14, color: anual ? '#EFF6FF' : '#3D4F6A', fontWeight: anual ? 700 : 400 }}>Anual</span>
            ...
            return (
              <div
                ...
                style={{
                  ...
                  background: p.destaque ? 'linear-gradient(160deg, #13183a 0%, #0E1525 100%)' : '#0E1525',
              ...
              >
                ...
                <div style={{ padding: '28px 28px 32px' }}>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 20 }}>
                    ...
                    <div>
                      <h3 style={{ fontFamily: 'Space Grotesk, sans-serif', fontSize: 18, fontWeight: 800, color: '#EFF6FF', lineHeight: 1 }}>{p.label}</h3>
                  ...
                  <div style={{ marginBottom: 24 }}>
                    {preco === 0 ? (
                      <div style={{ fontFamily: 'Space Grotesk, sans-serif', fontSize: 38, fontWeight: 900, color: '#EFF6FF', letterSpacing: '-0.03em', lineHeight: 1 }}>
                        Grátis
                      </div>
                    ) : (
                      <>
                        <div style={{ display: 'flex', alignItems: 'flex-end', gap: 4 }}>
                          <span style={{ fontSize: 14, color: '#4B5768', fontWeight: 600, marginBottom: 6 }}>R$</span>
                          <span style={{ fontFamily: 'Space Grotesk, sans-serif', fontSize: 42, fontWeight: 900, color: p.destaque ? p.color : '#EFF6FF', letterSpacing: '-0.03em', lineHeight: 1 }}>
                            {preco}
                          </span>
                          <span style={{ fontSize: 13, color: '#4B5768', marginBottom: 6 }}>/mês</span>
                        </div>
                        ...
                        {anual && (
                          <p style={{ fontSize: 11, color: '#3D4F6A', marginTop: 2 }}>
                  ...
                  {ehAtual ? (
                    status?.tem_assinatura ? (
                      <button
                        ...
                        style={{ width: '100%', padding: '13px', borderRadius: 14, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6, fontSize: 14, fontWeight: 700, cursor: 'pointer', border: '1px solid rgba(255,255,255,0.1)', background: 'rgba(255,255,255,0.06)', color: '#CBD5E1' }}
                      >
                    ...
                    <div style={{ width: '100%', padding: '13px', borderRadius: 14, textAlign: 'center', fontSize: 13, color: '#3D4F6A', border: '1px solid rgba(255,255,255,0.07)' }}>
                    ...
                    <button
                      ...
                      style={{
                        ...
                        background: p.destaque
                          ...
                          : `${p.color}22`,
                        color: p.destaque ? '#0E1525' : p.color,
        ...
        <div style={{ marginTop: 52, textAlign: 'center' }}>
          <div style={{ display: 'flex', justifyContent: 'center', gap: 32, flexWrap: 'wrap', marginBottom: 24 }}>
            {[
              ...
              <div key={text} style={{ display: 'flex', alignItems: 'center', gap: 8, fontSize: 13, color: '#3D4F6A' }}>
                <Icon style={{ width: 15, height: 15, color: '#4B5768' }} />
                {text}
              </div>
            ))}
          </div>
