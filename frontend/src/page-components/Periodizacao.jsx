          ...
          <div>
            ...
            {programas.length > 0 && (
              <div style={{ display: 'flex', gap: 8, marginTop: 12 }}>
                <span style={{ padding: '4px 12px', borderRadius: 999, fontSize: 11, fontWeight: 600, background: 'rgba(99,102,241,0.12)', color: '#fca5a5', border: '1px solid rgba(99,102,241,0.25)' }}>
